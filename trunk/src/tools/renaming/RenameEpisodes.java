...
public class RenameEpisodes extends MyDraggable {
  ...
  private boolean validateValues() {
    ...
    if (group.validate()) {
      ...
      MyMessages.warning("Renaming Episodes Form", group.getErrorMessage(), true, true);
      return false;
    }
  }
  ...
  private void createTableModel() {
    ...
    if (oldNames.size() != newNames.size()) {
      ...
      MyMessages.error("Error", "An error occured, old names size != new names size", true, true);
      dispose();
    }
