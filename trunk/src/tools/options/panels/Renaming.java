...
public class Renaming extends javax.swing.JPanel  implements IMySeriesOptions {
  ...
  public Renaming() {
    initComponents();
    tf_episodeSep.addValidator(new RegularExpressionValidator("x", sepRegex, false, true));
    tf_seasonSep.addValidator(new RegularExpressionValidator("s", sepRegex, false, true));
    tf_titleSep.addValidator(new RegularExpressionValidator(" ", sepRegex, false, true));
