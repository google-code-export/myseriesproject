...
public class AdminSeries extends MyDraggable {
  ...
  public AdminSeries(MySeries m, SeriesRecord seriesRecord) throws SQLException {
    ...
    if (seriesRecord.getSeries_ID() > 0) {
      ...
      textfield_screenshot.setText(seriesRecord.getScreenshot().equals("") ? "" : Options._USER_DIR_ + Paths.SCREENSHOTS_PATH + seriesRecord.getScreenshot());
      setScreenshot();
      textfield_tvSubsId.setText(seriesRecord.getTvSubtitlesCode());
  ...
  private void addSeries() {
    ...
    private void myButtonOk1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButtonOk1ActionPerformed
      ...
      if (!group.validate()) {
        ...
        MyMessages.warning("Series Form", group.getErrorMessage(), true);
        return;
      }
      addSeries();
            ...
            if (cb_existingSeries.getSelectedIndex() > 0) {
              ...
              try {
                ...
                while (rs.next()) {
                  ...
                  textfield_screenshot.setText("./images/" + rs.getString("screenshot"));
                  textfield_subsOnline.setText(rs.getString("sonline"));
                  textfield_tvRageID.setText(String.valueOf(rs.getInt("tvrage_ID")));
                }
              } catch (SQLException ex) {
