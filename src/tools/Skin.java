...
public final class Skin {
  ...
  private static float lightness;
  ...
  public Skin(Color color) {
    MySeriesLogger.logger.log(Level.INFO, "Creating skin for color {0}", color);
    skinColor = color;
    lightness = getLightness();
    skinColor = fixColor(skinColor);
    createColors();
  ...
  public int getLightness() {
    ...
    return (int) Math.sqrt(
        skinColor.getRed() * skinColor.getRed() * .241
        + skinColor.getGreen() * skinColor.getGreen() * .691
        + skinColor.getBlue() * skinColor.getBlue() * .068);
  }
  ...
  public static void applySkin() {
    MySeriesLogger.logger.log(Level.INFO, "Applying the skin");
    /**
     * activeCaption
     */
